...
public final class SpanUtils {
     ...
     * @param flag The flag.
     *             <ul>
     *             <li>{Spanned#SPAN_INCLUSIVE_EXCLUSIVE}</li>
     *             <li>{Spanned#SPAN_INCLUSIVE_INCLUSIVE}</li>
     *             <li>{Spanned#SPAN_EXCLUSIVE_EXCLUSIVE}</li>
     *             <li>{Spanned#SPAN_EXCLUSIVE_INCLUSIVE}</li>
     *             </ul>
     ...
     *                   <ul>
     *                   <li>{Align#ALIGN_TOP   }</li>
     *                   <li>{Align#ALIGN_CENTER}</li>
     *                   <li>{Align#ALIGN_BOTTOM}</li>
     *                   </ul>
     * @return the single {SpanUtils} instance
     */
    public SpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight,
     ...
     *                  <ul>
     *                  <li>{Alignment#ALIGN_NORMAL  }</li>
     *                  <li>{Alignment#ALIGN_OPPOSITE}</li>
     *                  <li>{Alignment#ALIGN_CENTER  }</li>
     *                  </ul>
     * @return the single {SpanUtils} instance
     */
